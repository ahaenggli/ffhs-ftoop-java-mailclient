...
F�r die Anbindung des Mailservers wird Ihnen im Moodle eine Bibliothek zur Verf�gung gestellt.
Optional k�nnen noch folgende Funktionen implementiert werden:
- Verarbeitung von Attachments in empfangenen und gesendeten Mails
- Automatisches Abholen per Zeitintervall
- Anlegen, Bearbeiten und L�schen von lokalen Mail Ordnern
...
public class MailClient_Hauptfenster extends JFrame {
	...
	private JMenuBar guiGetMenu() {
		...
		// Neues Mail machen
				Neuesmail = new JMenuItem("Einstellungen l�schen");
	...
	/**
	 * Gibt Ordner-Bereich f�r linken Teil des GUI zur�ck
	 * @return
	 */
	...
	public JScrollPane guiGetMailListe() {
		...
		{			
			...
			setStatusBarText(counter + " Mails gel�scht");
			refreshMailListe();
		}
	...
	public MailClient_Hauptfenster() {
		...
		/*
		 *  F�ge Komponenten zum Hauptschirm dazu
		 *  Kompenenten werden in eigenen Methoden aufgebaut f�r 
		 *  bessere �bersicht
		 */
	...
	/**
	 * H�ngt einem Ordner andere Ordner unter
	 * @param parent
	 * 			Diesem Element werden die anderen angeh�ngt
	 * @param Elements
	 * 			Elemente zum anh�ngen
	 */
